...
const translations = {
  zh: {
    ...
    close: '關閉',
    startChat: '開始聊聊 →',
    lawyerDisclaimer1: '這是 AI 模擬對話情境，供教育用途，不構成法律建議。',
    lawyerDisclaimer2: '輸入內容會傳送至第三方 AI 服務進行分析與回應生成，請避免輸入個人資料或敏感資訊。',
    talkToLawyer: '跟律師聊聊 →',
    switchLawyer: '換律師聊',
  ...
  en: {
    ...
    lawyerDisclaimer1: 'This is an AI-simulated conversation for educational purposes and does not constitute legal advice.',
    lawyerDisclaimer2: 'Your input is sent to a third-party AI service for analysis and response generation. Please avoid entering personal data or sensitive information.',
