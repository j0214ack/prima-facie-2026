...
const translations = {
  zh: {
    ...
    close: '關閉',
    startChat: '開始聊聊 →',
    lawyerDisclaimer1: '本平台不會保存對話紀錄。',
    lawyerDisclaimer2: '但輸入內容會傳送至第三方 AI 服務進行分析與回應生成，請避免輸入個人資料或敏感資訊。',
    talkToLawyer: '跟律師聊聊 →',
    switchLawyer: '換律師聊',
  ...
  en: {
    ...
    lawyerDisclaimer1: 'This platform does not store conversation records.',
    lawyerDisclaimer2: 'However, your input is sent to a third-party AI service for analysis and response generation. Please avoid entering personal data or sensitive information.',
